...
<body>
    ...
    require_once("../../actions/denuncia/listardenuncias.php");
    ?>

    <main>
        <h2 id="titulod">Denúncias</h2>
        ...
        <?php
            foreach($listaDenuncias as $key => $denuncia){
                ...
                echo "<td>{$data}</td>";
                echo "<td><a href='../../actions/denuncia/insertrecebe.php?id_denuncia={$denuncia['id_denuncia']}'><button>Visualizar denúncia</button></a></td>";
                echo "</tr>";
            }
        ?>
        </table>
