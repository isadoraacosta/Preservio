...
<main>
    ...
    <div id="tudo">
        ...
        if (!isset($_GET['msg_sucesso'])) {
        ?>
        <form action="../../actions/denuncia/insertdenuncia.php" method="post" name="denuncia" enctype="multipart/form-data">
            ...
            <div id="containerform" class="containerform">
                ...
                <div id="parte4" class="parteform">
                    ...
                    <div class="icone">
                        ...
                        <textarea name="descricao" id="descricao" cols="100px" rows="30px" required></textarea>
                    </div>
