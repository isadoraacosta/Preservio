...
require_once("../../actions/usuario/sessoes.php");
...
$id= $_SESSION['login']; 
$sql = "SELECT nome, sobrenome, data_nasc, email, senha FROM usuario WHERE email = ?;";
...
<main>
    ...
    border: 4px solid #1f6031; padding:40px 50px; color:#1f6031;"></i>
        ...
        <p>Visualize as informações da sua conta e alterá-las, se necessário.</p>
    </div>

    <form action="../../actions/usuario/atualizarperfiluser.php" class="informacoes" name="cadadm" method="post">
