...
<main>
    <div id="carrossel" >
        <div class="slideshow-container">
            <a href="../noticia/noticiauser.php">
    ...
    <div id="div2">
        ...
        <div id="importancia">
            <h2 class=" titulo titulo-importancia" >Qual a importância de <a id="prestar" href="../denuncia/realizardenunciauser.php">prestar denúncia?</a></h2>
    ...
    <div id="botaodenuncia">
        ...
        <a href="../denuncia/realizardenunciauser.php">CLIQUE AQUI</a>
    </div>
    ...
    <div id="sobre2">
        ...
        <div class="container">
            <div class="block">
                <div class="autor">
                    <img src="../../../public/img/pexels-photo-753873.jpeg" alt="">
                </div>
                <div class="text">
                    <h2>Autora</h2>
                    <h1>Fulana</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore quas sint accusamus ea commodi, repellendus temporibus possimus laboriosam magnam provident at excepturi porro natus tempora! Velit eligendi aperiam ea alias quas? </p>
                </div>
            </div>
            <hr class="linha">
            ...
            <div class="block">
                ...
                <div class="text">
                    <h2>Autora</h2>
                    <h1>Fulana</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore quas sint accusamus ea commodi, repellendus temporibus possimus laboriosam magnam provident at excepturi porro natus tempora! Velit eligendi aperiam ea alias quas? Eos suscipit ratione ad tempora! Tempora sed similique possimus repellendus quia quae aut iusto, modi sint.</p>
                </div>
            </div>
            <hr class="linha">
...
<div id="conjnoticias">
            ...
            <div id="noticias">
                ...
                if ($result->num_rows > 0) {
                    while ($noticia = $result->fetch_assoc()) {
                        ...
                        echo '<a href="../noticia/noticiauser.php?id_noticia=' . $noticia['id_info'] . '">';
            ...
            <a href="../noticia/noticiasuser.php" id="lermais"> Ler todas as notícias  ˃ </a>
        </div>
