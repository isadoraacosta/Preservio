...
<head>
    ...
    <style>
        /* Adicione estas classes para o modo escuro */
        .dark-mode header {
        ...
        .dark-mode footer a, .dark-mode footer p, .dark-mode footer i {
            color: #ffffff !important; /* Força a cor branca para textos e ícones no footer */
        }

        header, header .logo, header .menu, header .menu a {
    color: white;
    background-color: white; /* caso o fundo dos elementos também precise ser branco */
    transition: all 0.3s ease-in-out;
}

header.pequena, header.pequena .logo, header.pequena .menu, header.pequena .menu a {
    color: white;
    background-color: white; /* caso o fundo dos elementos também precise ser branco */
}
...
<div id="carrossel">
    <div class="slideshow-container">
        ...
        // Consulta para selecionar as 4 últimas imagens do banco de dados
        $sql = "SELECT id_info, imagem FROM informacoes ORDER BY data_postagem DESC LIMIT 4";
        $result = $mysqli->query($sql);

        if ($result->num_rows > 0) {
            while ($noticia = $result->fetch_assoc()) {
                // Verifica se o valor da imagem não é null
                if (!is_null($noticia['imagem']) && $noticia['imagem'] !== '') {
                    echo '<a href="../noticia/noticia.php?id_noticia=' . $noticia['id_info'] . '">';
                    echo '<img src="../../../public/img/noticia/' . $noticia['imagem'] . '" alt="Slide ' . $noticia['id_info'] . '">';
                    echo '</a>';
                }
            }
        } else {
    ...
    <div id="div2">
        ...
        <div id="importancia">
            <h2 class=" titulo titulo-importancia" >Qual a importância de <a id="prestar" href="../denuncia/realizardenuncia.php">prestar denúncia?</a></h2>
    ...
    <div id="botaodenuncia">
        ...
        <a href="../denuncia/realizardenuncia.php">CLIQUE AQUI</a>
    </div>
...
<div id="conjnoticias">
            ...
            <a href="../noticia/noticias.php" id="lermais"> Ler todas as notícias  ˃ </a>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateColors = () => {
                if (document.body.classList.contains('dark-mode')) {
                    icon.style.color = '#ffffff'; // Branco

                    // Aplicar classes de modo escuro
                    document.body.classList.add('dark-mode');
                } else {
                    icon.style.color = '#1f6031'; // Verde original

                    // Remover classes de modo escuro
            ...
            updateColors(); // Atualiza as cores ao carregar a página, dependendo do estado atual do modo escuro
        });
    </script>
