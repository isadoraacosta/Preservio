...
require_once("../usuario/sessoes.php");
...
if(empty($_POST['assunto'])){
    ...
    $id_user = isset($_SESSION['usuario']) ? $_SESSION['usuario'] : NULL;
    ...
    $stmt->bind_param("sssssssisi", $anexo, $status_denuncia, $data, $hora, $assunto, $local, $descricao, $id_user, $data_hoje, $tipo_id);
    $stmt->execute();
    ...
    header("Location: ../../pages/denuncia/realizardenunciauser.php?msg_sucesso=$msg");
    exit();
}
